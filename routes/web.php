...
Route::middleware([
    ...
    Route::post('/storecommande', [CommandesController::class, 'storefromintervention'])->name('storecommande');
    Route::put('/updatequantitecommande/{commande}', [CommandesController::class, 'updatequantitecommande'])->name('updatequantitecommande');
    Route::post('/annulercommande/{commande}', [CommandesController::class, 'annulercommande'])->name('annulercommande');
    Route::get('/intervention/calendarupdate', [InterventionController::class, 'updatecalendar'])->name('Intervention.updatecalendar');
    Route::get('technicien', 'App\Http\Controllers\TechnicienController@index')->name('Technicien.index');
    Route::get('/intervention/calendarupdate2', [InterventionController::class, 'updatedates'])->name('Intervention.updatedates');
