...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-indigo-500 border-b border-gray-300">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <img :src="'/img/afriqindus_logo.png'" class="block h-14 w-auto"/>
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetDropdown class="hover:border-b-2 hover:border-gray-300" :class="{'border-b-2 border-white' : route().current('interventions.index') || route().current('clients.index') || route().current('calendar')}">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md mt-5">
                                            <button type="button" class="inline-flex items-center px-1  pt-1 border-b-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-500 focus:outline-none transition">
                                                INTERVENTIONS
                                                <svg
                                    ...
                                    <template #content>
                                        <div class="w-48">
                                                ...
                                                <JetDropdownLink :href="route('clients.index')">
                                                    Clients
                                                </JetDropdownLink>
                                                <JetDropdownLink :href="route('interventions.index')">
                                                    Interventions
                                                </JetDropdownLink>
                                                <JetDropdownLink :href="route('calendar')">
                                                    Planification
                                                </JetDropdownLink>
                                        </div>
                                    </template>
                                </JetDropdown>
                                <JetDropdown class="hover:border-b-2 hover:border-gray-300" :class="{'border-b-2 border-white' : route().current('articles.index') || route().current('commandes.index') || route().current('fournisseurs.index')}">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md mt-5">
                                            <button type="button" class="inline-flex items-center px-1  pt-1 border-b-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-500 focus:outline-none transition">
                                                ARTICLES
                                    ...
                                    <template #content>
                                        <div class="w-48">
                                                ...
                                                <JetDropdownLink :href="route('articles.index')">
                                                    Articles
                                                </JetDropdownLink>
                                                <JetDropdownLink :href="route('fournisseurs.index')">
                                                    Fournisseurs
                                                </JetDropdownLink>
                                                <JetDropdownLink :href="route('commandes.index')">
                                                    Commandes
                                                </JetDropdownLink>
                                        </div>
                                    </template>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('clients.index')" :active="route().current('clients.index')">
                            CLIENT
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('interventions.index')" :active="route().current('interventions.index')">
                            INTERVENTIONS
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('calendar')" :active="route().current('calendar')">
                            PLANIFICATION
                        </JetResponsiveNavLink>
